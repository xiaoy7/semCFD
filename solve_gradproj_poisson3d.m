function P = solve_gradproj_poisson3d(R, Tx,Ty,Tz, TxInv,TyInv,TzInv, Lambda3D)
...
% Zero the (1,1,1) component of RHS; set P̂(1,1,1)=0
Rhat(1,1,1) = 0;

% Divide by eigenvalue sum (avoid div-by-zero at (1,1,1))
P = Rhat ./ max(Lambda3D, eps);

% Back transform
tmp = tensorprod(P, Tz', 3, 1);
